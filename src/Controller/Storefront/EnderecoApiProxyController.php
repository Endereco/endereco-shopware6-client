...
/**
 * Ultra-lightweight proxy controller for Endereco API requests.
 * 
 ...
 * real-time API requests (address validation, street split ...).
 * 
...
class EnderecoApiProxyController
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        try {
            ...
            return new Response('Endereco service temporarily unavailable', 503, [
                'X-Robots-Tag' => 'noindex, nofollow'
            ]);
        }
    }
