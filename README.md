...
**Description:** Automatically downloads Shopware production releases (6.6.0.0, 6.6.1.2, 6.6.2.0, 6.6.3.1, 6.6.4.1, 6.6.5.1, 6.6.6.1,
 6.6.7.1, 6.6.8.2, 6.6.9.0, 6.6.10.6) from GitHub and extracts them into the `shops/` directory.
