...
rsync -ar --exclude 'vendor' --exclude 'shops' --exclude 'node_modules' ./* ./EnderecoShopware6ClientStore
...
rsync -ar --exclude 'vendor' --exclude 'shops' --exclude 'node_modules' --exclude "EnderecoShopware6ClientStore-$branch.zip" ./* ./EnderecoShopware6Client
